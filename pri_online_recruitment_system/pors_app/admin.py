...
class PRIUserPermissionAdmin(ImportExportModelAdmin):
    list_display = ('id', 'pri_user', 'pri_is_admin', 'pri_is_clients', 'pri_is_hired',
                    'pri_is_jobs', 'pri_is_application_form', 'pri_is_applicants')
    list_editable = ('pri_is_admin', 'pri_is_clients', 'pri_is_hired',
                     'pri_is_jobs', 'pri_is_application_form', 'pri_is_applicants')
    list_per_page = 10
...
class PRIApplicantJobRequestAdmin(ImportExportModelAdmin):
    list_display = ('id', 'job_vacancy_applied',
                    'applying_applicant', 'take_exam', 'date_applied')
    list_editable = ()
    list_per_page = 10
...
class PRIApplicantJobHiredAdmin(ImportExportModelAdmin):
    list_display = ('id', 'applicant_id','company_name', 'hired_applicant', 'date_hired')
    list_editable = ('applicant_id',)
    list_per_page = 10
    search_fields = ('id', 'applicant_id','company_name', 'hired_applicant', 'date_hired')
    list_filter = ('company_name', 'date_hired')

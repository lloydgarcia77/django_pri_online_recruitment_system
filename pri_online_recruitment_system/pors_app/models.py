...
class PRIUserPermission(models.Model):
    ...
    pri_user = models.OneToOneField(PRIUserInfo, on_delete=models.CASCADE, related_name='permission_user_info_fk')
...
class PRIApplicantProfileInfo(models.Model):
    ...
    erp_question = MultiSelectField(choices=ERP_QUESTION_LIST, verbose_name="How did you found out about thid job?")
...
class PRIApplicantEducationalAttainmentInfo(models.Model):
    ...
    college = models.CharField(max_length=200, verbose_name="Name of School", blank=True)
    college_course = models.CharField(max_length=50, blank=True)
    college_address = models.CharField(max_length=200, blank=True)
    csya_from = models.DateField(verbose_name="From")
    csya_to = models.DateField(verbose_name="To")
   
    vocational = models.CharField(max_length=200, verbose_name="Name of School", blank=True)
    vocational_course = models.CharField(max_length=50, blank=True)
    vocational_address = models.CharField(max_length=200, blank=True)
    vsya_from = models.DateField(verbose_name="From")
    vsya_to = models.DateField(verbose_name="To")
   
    highschool = models.CharField(max_length=15, blank=True)
    ...
    elementary = models.CharField(max_length=150, blank=True)
    elementary_address = models.CharField(max_length=250, blank=True)

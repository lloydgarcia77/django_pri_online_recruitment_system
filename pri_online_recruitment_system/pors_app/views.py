...
class PriAdminDashboard(LoginRequiredMixin,TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        try:
            profile = PRIUserInfo.objects.all().get(user__in=user, level='Administrator')
